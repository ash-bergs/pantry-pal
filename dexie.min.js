(function (e, t) {
  ...
  function Qn(e, h, t, n, r, i) {
    if (!t || 0 === t.length) return e;
    var o = h.query.index,
      d = o.multiEntry,
      p = h.query.range,
      y = n.schema.primaryKey.extractKey,
      v = o.extractKey,
        ...
        switch (t.type) {
          ...
          case 'put':
            var c = new gn().addKeys(
              ...
              n = e
                .filter(function (e) {
                  return !c.hasKey(h.values ? y(e) : e);
                })
                .concat(
                  h.values
                    ? r
            ...
            break;
          case 'delete':
            var l = new gn().addKeys(t.keys);
            n = e.filter(function (e) {
              return !l.hasKey(h.values ? y(e) : e);
            });
            break;
          case 'deleteRange':
            var f = t.range;
    ...
    return t === e
      ? e
      : (t.sort(function (e, t) {
          return st(a(e), a(t)) || st(y(e), y(t));
        }),
        h.limit &&
          h.limit < 1 / 0 &&
          (t.length > h.limit
            ? (t.length = h.limit)
            : e.length === h.limit && t.length < h.limit && (r.dirty = !0)),
        i ? Object.freeze(t) : t);
  }
  function Gn(e, t) {
    return (
